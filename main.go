...
var defaultEnabledServices = []string{"network", "network-base" ,"network-sg" , "network-router", "network-port", "compute", "compute-base", "compute-limit", "compute-total-vms", "image", "volume", "identity", "object-store", "load-balancer", "container-infra", "dns", "baremetal", "gnocchi", "database", "orchestration", "placement"}
