...
var defaultEnabledServices = []string{"network", "network-base" , "network-router", "network-port", "compute", "image", "volume", "identity", "object-store", "load-balancer", "container-infra", "dns", "baremetal", "gnocchi", "database", "orchestration", "placement"}
