...
var defaultEnabledServices = []string{"network", "network-router", "network-port", "compute", "image", "volume", "identity", "object-store", "load-balancer", "container-infra", "dns", "baremetal", "gnocchi", "database", "orchestration", "placement"}
